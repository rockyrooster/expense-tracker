              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-4">
                ...
                {shareLink ? (
                  <div className="flex gap-2">
                    ...
                    <button onClick={copyLink} className="px-3 py-2 text-xs bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 rounded-lg hover:bg-slate-700 dark:hover:bg-white transition-colors whitespace-nowrap">Copy</button>
                  </div>
                ) : (
                  <button
          ...
          <div className="p-5 border-t border-slate-200 dark:border-slate-800 space-y-2">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 text-sm bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 rounded-lg hover:bg-slate-700 dark:hover:bg-white transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
